...
public class @Inputs : IInputActionCollection, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""Player"",
            ""id"": ""886da6bd-c7fb-47d1-a379-c3a6e4f65bd5"",
            ""actions"": [
                {
                    ""name"": ""Move"",
                    ""type"": ""PassThrough"",
                    ""id"": ""bd895a6f-853a-4608-806d-64d09294c71b"",
                ...
                },
                {
                    ""name"": ""Jump"",
                    ""type"": ""Button"",
                    ""id"": ""9444d5ae-c28c-4808-934e-71302ca99785"",
                ...
                },
                {
                    ""name"": ""Sprint"",
                    ""type"": ""Button"",
                    ""id"": ""44ed4b2d-aab2-4fe7-802c-2a99f20fbc54"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""Crouch"",
                    ""type"": ""Button"",
                    ""id"": ""6bfbd488-f82a-425c-b813-567b8e6d224d"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""Flashlight"",
                    ""type"": ""Button"",
                    ""id"": ""42607542-6907-4bc2-a369-69eb0e8506f4"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                {
                    ""name"": ""WASD"",
                    ""id"": ""e7fb69bf-5dc0-4176-ac8a-4da1a0179a66"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""c9a48da0-c135-4d1c-937e-e7e6691eead2"",
                    ""path"": ""<Keyboard>/w"",
                    ""interactions"": """",
                    ""processors"": """",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""1b00dc74-2f96-4a90-ae95-6fbc7df7ec2b"",
                    ""path"": ""<Keyboard>/s"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard & Mouse"",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""9023e5e2-3b28-4ceb-b082-c5cba18c176c"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard & Mouse"",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""02046058-a0c0-4261-a97d-cfc09a490e75"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard & Mouse"",
                ...
                {
                    ""name"": """",
                    ""id"": ""3c9e7d2e-37a4-4bd9-b4b7-4545152d7f98"",
                    ""path"": ""<Keyboard>/space"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard & Mouse"",
                ...
                {
                    ""name"": """",
                    ""id"": ""80a0d328-154f-4ef7-ba89-d04d9d6ee1a8"",
                ...
                {
                    ""name"": """",
                    ""id"": ""13eca536-598a-4b26-b4f4-0d41389294cc"",
                ...
                {
                    ""name"": """",
                    ""id"": ""9ceca75a-9f2e-4f09-8eda-34d40b9101d3"",
                    ""path"": ""<Keyboard>/f"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard & Mouse"",
        ...
        {
            ""name"": ""Mouse"",
            ""id"": ""8cf861a3-02d7-401c-884a-dd8cd8028638"",
            ""actions"": [
                {
                    ""name"": ""Position"",
                    ""type"": ""Value"",
                    ""id"": ""fa40c469-2247-4b56-9279-1e456953d77c"",
                ...
                },
                {
                    ""name"": ""Delta"",
                    ""type"": ""Value"",
                    ""id"": ""ad47f858-74b0-49e6-bf85-cbff5b9db319"",
                    ""expectedControlType"": ""Vector2"",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""LeftClick"",
                    ""type"": ""Button"",
                    ""id"": ""428ad6f8-9e91-40f5-a60f-8dd7c7d586c5"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""RightClick"",
                    ""type"": ""Button"",
                    ""id"": ""445a323a-8c93-4fe2-b2f0-1c7d676deac8"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""MiddleClick"",
                    ""type"": ""Button"",
                    ""id"": ""46720678-99f6-4242-aa41-e3cd8b8a1844"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""d034e672-47ae-4167-a380-48d3276e2194"",
                    ""path"": ""<Mouse>/position"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard & Mouse"",
                ...
                {
                    ""name"": """",
                    ""id"": ""469256f7-e517-45bd-8ee8-c5faea3960b1"",
                    ""path"": ""<Mouse>/delta"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard & Mouse"",
                ...
                {
                    ""name"": """",
                    ""id"": ""e06dbf06-9941-4168-961a-bb60d3383682"",
                ...
                {
                    ""name"": """",
                    ""id"": ""bbf18eaf-d58f-4f1f-80cc-83ffb756b05a"",
                ...
                {
                    ""name"": """",
                    ""id"": ""99dc8ac8-5bf8-4e8c-8805-e08ec993ddd8"",
        ...
        {
            ""name"": ""General"",
            ""id"": ""ef7d545d-f9a9-4949-8355-b601ce065998"",
            ""actions"": [
                {
                    ""name"": ""Pause"",
                    ""type"": ""Button"",
                    ""id"": ""bab40788-b1e8-4785-93a7-bc2bbdf759ef"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""9f076e16-5576-409b-bb82-87f05d51f067"",
